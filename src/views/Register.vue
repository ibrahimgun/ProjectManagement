              ...
              <v-row class="">
                  ...
                  <v-card-text>
                    <v-form class="signup-form-form">
                      ...
                      <div class="text-center mt-6">
                        <v-btn @click="register" type="submit" large :color="bgColor" dark>ÜYE OL</v-btn
                        >
                      </div>
                    </v-form>
                  </v-card-text>
                ...
                >
                  <div>
                    <v-card-text :class="`${fgColor}--text`">
                      <h1 class="text-center headline mb-3"></h1>
                ...
                <span>YÖNETİM</span>
                    ...
                    <div class="text-center mb-6">
                      <v-btn dark outlined route :to="'/login'">ÜYE GİRİŞİ</v-btn>
                    </div>
                  </div>
                </v-col>
              </v-row>
